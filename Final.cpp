...
int main()
{
	...
	int allocation[10],max[10],need[10],flag[10],sequence[10],maxPro=0,ch=0;;
	printf("----------------------------------\n");
	...
	if(ch==0)
		...
		{
			printf("\n\n P+Q is less than available\n");
		}
	}
	else
	{
		printf("\n\n Max allocation is greater than total process\n\n");
	}
}
